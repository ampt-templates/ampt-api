...
// index.ts
var import_sdk = require("@ampt/sdk");
var import_suretype = require("suretype");
...
var ApiRouter = class {
  ...
  constructor({
    ...
    this.validate = schema ? (0, import_suretype.compile)(import_suretype.v.object(schema), { ajvOptions: { coerceTypes: true } }) : () => ({ ok: true });
  }
...
var Group = class {
  ...
  router(prefix, schema, ...middleware) {
    ...
    import_sdk.http.use(prefix, async (_fetchRequest) => {
